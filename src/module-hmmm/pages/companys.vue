  ...
  <div class="dashboard-container">
    <div class="app-container">
      ...
      <el-card class="box-card">
            ...
            <template slot-scope="scope">
              ...
              >
                <el-button
                  ...
                  :icon="
                    scope.row.state === 1 ? 'el-icon-close' : 'el-icon-check'
                  "
                  circle
                  size="mini"
                ></el-button>
        ...
        >
          ...
          <span slot="footer" class="dialog-footer">
            <el-button class="btnright" @click="addDialogVisible = false"
              >取 消</el-button
            >
            <el-button class="btnright" type="primary" @click="addCompany"
              >确 定</el-button
            >
          </span>
        </el-dialog>
      ...
      >
        ...
        <span slot="footer" class="dialog-footer">
          <el-button class="btnright" @click="editDialogVisible = false"
            >取 消</el-button
          >
          <el-button class="btnright" type="primary" @click="editCompany"
            >确 定</el-button
          >
        </span>
      </el-dialog>
  ...
  data() {
    return {
      ...
      addFormRules: {
        ...
        province: [
          { required: true, message: "请输入城市地区", trigger: "blur" }
        ],
